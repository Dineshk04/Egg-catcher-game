...
color_cycle = cycle(['light blue', 'light pink', 'light green', 'light yellow', 'red', 'blue', 'violet'])
egg_width = 45
egg_height = 55
egg_score = 10
egg_speed = 500
...
score = 0
score_text = c.create_text(10, 10, anchor='nw', font=('arial', 18, 'bold'), fill='dark blue',
                           text='Score : ' + str(score))

lives_remaining = 3
lives_text = c.create_text(canvas_width - 10, 10, anchor='ne', font=('arial', 18, 'bold'), fill='dark blue',
